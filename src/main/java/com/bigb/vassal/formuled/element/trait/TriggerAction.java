...
public class TriggerAction extends AbstractTrait {
    public TriggerAction(String description, String menuCommand, HotKey keyboardCommand, Expression trigger,
    ...
    private TriggerAction(String description, String menuCommand, HotKey keyboardCommand, Expression trigger,
